...
@CucumberOptions(
		features = "C:\\Users\\sokoeurn chhay\\Selenium_Java_Review\\TechfiosBDDFramework2\\src\\main\\java\\features\\Login.feature", 
...
//		tags = {"@End2End, @Smoke, @RegressionTest"}	// , mean or 
		tags = {"@End2End, @Smoke", "@RegressionTest"}	// "..." , "..." mean and 
//		tags = {"~@End2End, ~@Smoke", "~@RegressionTest"}	// ~ means ignore test case 
		)
